...
I went the other direction — hyperconverged infrastructure. Multiple small form-factor nodes, each carrying both compute and storage, working together as a cluster. Three Dell OptiPlex 5090 SFFs in Phase 1, expanding to five in Phase 2.
...
The trade-off is complexity. More nodes means more hardware to buy, more cables to run, more things that can fail. But that complexity is the point — it mirrors what you'd encounter in a real production environment, at a scale you can actually wrap your head around.
