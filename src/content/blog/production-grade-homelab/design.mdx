---
title: 'Designing a 5-Node OKD Cluster: From Requirements to Specifications'
description: 'Turning homelab goals into concrete specifications — node count, compute sizing, storage tiers, failure domains, and the boundary between design and procurement.'
date: 2026-03-02
...
[Previous post](/blog/production-grade-homelab/why) laid out the goals: production-grade bare-metal OKD, distributed storage, VLAN segmentation, virtualization. Now we turn those into concrete specs.

This is the design post. No part numbers, no pricing, no vendor links. Requirements become decisions, decisions get justified. The BOM comes later.

## Starting with constraints

Every design starts with constraints. Ignoring them leads to solutions that look great on paper and blow up in practice.
...
<Callout title="Cluster design at a glance" variant="summary">
...
Every decision traces back to the requirements from the previous post. Hardware specifics come in the BOM post. Next up: network architecture — because none of this works without the right connectivity between nodes.
